export const adminPageOwnership: Record<string, string[]> = {
  ...
  "/admin/goals": ["projects.goals"],
  "/admin/goals/today": ["projects.goals"],
  "/admin/goals/week": ["projects.goals"],
  "/admin/goals/learning": ["projects.goals"],
  "/admin/goals/learning/week": ["projects.goals"],
  "/admin/goals/learning/streaks": ["projects.goals"],
  "/admin/goals/achievements": ["projects.goals"],
  "/admin/goals/settings": ["projects.goals"],
  ...
  "/admin/job-tracker/dashboard": ["jobs.tracker"],
  "/admin/job-tracker/companies": ["jobs.companies"],
  "/admin/job-tracker/jobs": ["jobs.pipeline"],
  "/admin/job-tracker/intake": ["jobs.intake"],
  "/admin/job-tracker/emails": ["jobs.email-ai"],
  "/admin/job-tracker/exports": ["jobs.exports"],
