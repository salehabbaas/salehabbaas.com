...
export function CreatorPillars({ pillars }: { pillars: Array<{ pillar: string; count: number }> }) {
  return (
    <div className="rounded-3xl border border-border/70 bg-card/75 p-6 shadow-elev2 backdrop-blur">
      <h3 className="font-serif text-2xl text-foreground">What I post about</h3>
      <p className="mt-2 text-sm text-foreground/75">Core topic pillars across my content system.</p>
